...
def cme_inpt_gateway_load(spt_path_demand,
    ...
    """Load demand and supply CSV to panda, convert to dict, strip wage and quantity
    """
...
def cme_inpt_gateway_simu(it_fixed_group=11,
    ...
    In contrast to `cme_inpt_gateway_load`, which loads in csv files 
    that contain existing parameters, here we generate/simulate parameters. 
    ...
    # First, we define some default parameters
